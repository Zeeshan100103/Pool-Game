...
public class Ball implements Drawable, Movable {
    ...
    public Ball(String colour, double xPos, double yPos, double xVel, double yVel, double mass, BallType type, BallPocketStrategy pocketAction) throws IllegalArgumentException {
        ...
        //create rodline
        this.rodline = new RodLine();
        this.rodline.disableRod();
    }
    ...
    public void addToGroup(ObservableList<Node> groupChildren) {
        ...
        //line
        this.rodline.addToGroup(groupChildren);
    }
    ...
    private void registerCueBallMouseAction() {
        this.shape.setOnMouseDragged(
            (actionEvent) -> {
                if (this.hasStopped()) {
                    ...
                    this.rodline.enableRod();
                    this.rodline.updaterod(this.shape.getCenterX(), this.shape.getCenterY());
                    this.rodline.updateangle(this.shape.getCenterX(), this.shape.getCenterY(),actionEvent.getSceneX(),actionEvent.getSceneY());
                }
            }
        );
        this.shape.setOnMouseReleased(
            (actionEvent) -> {
                if (this.hasStopped()) {
                	reg_undo.returnmemto().update_record();
    ...
    */
    ...
    /**
     * Set the colour of the ball.
     * @return colour The new colour of the ball.
     */
    ...
    /**
     * Enable Ball display after undo
     * @param isdis A boolean ro check if ball disable
     */
    public void enableBall(Boolean isdis) {
    	if(!(isdis))
    		this.shape.setVisible(true);
    	this.disabled = isdis;
    }
    ...
    /**
     * Set the undo option for ball.
     * @param udo A undo command input
     */
    public void registerUndoOption(Undo udo) {
    	reg_undo = udo;
    }
}
